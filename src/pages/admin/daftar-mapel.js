                ...
                <table className="w-full bg-white border-2-b">
                  <thead>
                    <tr>
                      ...
                      <th className="py-2 px-4 border border-slate-600">Mapel</th>
                      <th className="py-2 px-4 border border-slate-600">Kelas</th>
                  ...
                  <tbody>
                    {filteredData.map((data, index) => (
                      <tr key={index} className="border border-slate-600">
                        ...
                        <td className="py-2 px-4 border border-slate-600">{data.mapel}</td>
                        <td className="py-2 px-4 text-center border border-slate-600">{data.kelas}</td>
            ...
            {showModal && dataDetail && (
              ...
              >
                <div className="bg-white m-auto py-5 px-14 border border-gray-400 w-4/5">
                  ...
                  <div className="flex justify-between items-center gap-3 my-2">
                    <p className="w-full">Mapel</p>
                    <p className="text-center">:</p>
                    <p className="w-full">{dataDetail.mapel}</p>
                  </div>
                  <div className="flex justify-between items-center gap-3 my-2">
                    <p className="w-full">Kelas</p>
                    <p className="text-center">:</p>
                    <p className="w-full">{dataDetail.kelas}</p>
                  </div>
                  <div className="flex justify-between items-center gap-3 my-2">
                    <p className="w-full">Pengajar</p>
                    <p className="text-center">:</p>
                    <p className="w-full">{dataDetail.pengajar}</p>
                  </div>
